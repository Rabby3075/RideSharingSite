...
<div class="wrapper">
    <div class="sidebar">
        <a href="{{route('updateAdminProfile')}}"><img src="image/index.png">{{Session::get('user')}}</a>
        <ul>
            <li><a href="#"><i class="fas fa-home"></i>Home</a></li>
            <li><a href="#"><i class="fas fa-user"></i>Profile</a></li>
            <li><a href="#"><i class="fas fa-address-card"></i>About</a>
               <div class="submenu">
                  <ul>
                     <li><a href="#"><i class="fas "></i>Map</a></li>
                  </ul>
               </div>
            </li>
