  ...
  <table class="table" style="text-align: center">
    ...
    @foreach($rideList as $ride)
     ...
     <tr>
        ...
        <td ><span class="badge bg-warning text-dark me-2 cancel-btn">Wait for rider</span><a class="btn btn-danger" id="cancel-ride" href="javascript:void(0)" data-url="{{ route('rideCancel', $ride->id) }}"><i class="bi bi-x-circle-fill"></i></a></td>
