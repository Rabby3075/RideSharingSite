    ...
    <div class="" style="margin-top:100px">
        <div class="rounded d-flex justify-content-center">
            <div class="col-md-4 col-sm-12 shadow-lg bg-light">
                ...
                <form action="{{route('customerCreateSubmit')}}" class="form-group" method="post"
                    ...
                    <div class="p-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                   value="{{session('user') ? session('user.name') : old('name')}}"
                                   placeholder="Name"><br>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" name="address" id="address"
                                   value="{{old('address')}}" placeholder="Your Address"><br>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="username" id="username"
                                   value="{{old('username')}}" placeholder="Username"><br>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                   value="{{session('user') ? session('user.email') : old('email')}}"
                                   placeholder="Email">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" class="form-control" name="password" id="password"
                                   value="{{old('password')}}" placeholder="password"><br>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" type="file" id="formFile" name="image" id="image"
                                   value="{{old('image')}}" placeholder="Upload Image"><br>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="{{ url('authorized/facebook') }}" class="fb-btn">
