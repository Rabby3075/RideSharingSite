        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="wrap d-md-flex">
                    <div class="img"
                         style="background-image: url(../image/rideShare.jpg); background-repeat: no-repeat; background-size: contain;">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="{{route('customerLoginSubmit')}}" class="signin-form" method="post" name="form"
