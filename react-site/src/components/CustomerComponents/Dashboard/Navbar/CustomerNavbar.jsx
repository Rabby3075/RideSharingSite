...
<div className="collapse navbar-collapse" id="collapsibleNavbar">
    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        <li className="nav-item me-4">
          <a className="nav-link" href="/customer/home"><i className="bi bi-house-fill me-1"></i>Home</a>
        </li>
        <li className="nav-item me-4">
          <a className="nav-link" href="/customer/riderequest"><i className="bi bi-truck-front-fill me-1"></i>Request for a ride</a>
        </li>
        <li className="nav-item me-4">
          <a className="nav-link" href="/customer/ridehistory"><i className="bi bi-clipboard2-data-fill me-1"></i>Ride History</a>
        </li>
